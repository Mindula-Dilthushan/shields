...
- Retire [BitbucketIssues] badges [#12171](https://github.com/badges/shields/issues/12171)
- Increase PyPI caches again [#12170](https://github.com/badges/shields/issues/12170)
- refactor [Coveralls Discourse Jitpack MavenMetadata Polymart] to use `routeEnum` [#12168](https://github.com/badges/shields/issues/12168)
- refactor [DepsRsRepo EclipseMarketplaceDownloads Homebrew SpigetRatings Terraform] to use `routeEnum` [#12165](https://github.com/badges/shields/issues/12165)
- refactor [Bundlephobia CratesDownloads Depfu DubDownloads GemRank] to use `routeEnum` [#12164](https://github.com/badges/shields/issues/12164)
- Improve [ChromeWebStore] rating count handling and fix all examples [#12160](https://github.com/badges/shields/issues/12160)
- refactor: migrate static prefix from route pattern to route base [clearlydefined coderabbit conda crates github greasyfork homebrew openvsx pepy poeditor winget] [#12093](https://github.com/badges/shields/issues/12093)
- Switch to non-mocked [Classicpress] not found tests [#12161](https://github.com/badges/shields/issues/12161)
- Add [ClassicPress] badge [#12097](https://github.com/badges/shields/issues/12097)
- Update simple-icons to 16.30.0 [#12159](https://github.com/badges/shields/issues/12159)
- Update simple-icons to 16.29.0 [#12148](https://github.com/badges/shields/issues/12148)
- [OSSFScorecard] Read api.scorecard.dev, not the diverged legacy host [#12121](https://github.com/badges/shields/issues/12121)
- add version filter to [Nexus] [#11745](https://github.com/badges/shields/issues/11745)
- fix: correct regex for triple dotted version validation [#12120](https://github.com/badges/shields/issues/12120)
- Retire [YouTube] badges [#12113](https://github.com/badges/shields/issues/12113)
- Fix [DockerVersion DockerSize] pagination [#12111](https://github.com/badges/shields/issues/12111)
- Fix server test failure [#12114](https://github.com/badges/shields/issues/12114)
- [GitLab]: Adds label badges and tests [#12112](https://github.com/badges/shields/issues/12112)
- Changelog for Release server-2026-08-15 [#12110](https://github.com/badges/shields/issues/12110)
- [Copr] Add build status badge [#11940](https://github.com/badges/shields/issues/11940)
